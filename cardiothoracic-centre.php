                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="bread-text bread-text2">
                                <h1 class="ortho-head"><span>Cardiothoracic </span> <br> Centre</h1>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="service-col">
                                <h2><strong>Cardio–Vascular–Thoracic Surgery</strong></h2>
                            ...
                            <ul class="hght-points mb-40">
                             ...
                             <div class="service-col">
                                <h2><strong>World Class Technology Cathlab</strong></h2>
                                <p class="mb-3">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quae nam, repudiandae soluta suscipit eaque sunt.</p>
                             </div>
                        ...
                        <div class="col-lg-6 second-col">
                            <div class="service-col">
                                <h2><strong>Facilities & Services</strong></h2>
                                <p class="mb-3">Lorem ipsum dolor sit amet consectetur adipisicing elit. Aut, rerum? A, eius ex error odio dolorem voluptatum eos eum repellendus optio deserunt molestiae eligendi dolor magnam quam numquam consequuntur vitae.</p>
                            </div>
                            <ul class="hght-points">
                                <li>24x7 Primary Angioplasty</li>
                                <li>Elective angioplasty including complex procedures</li>
                            ...
                            <div class="doctor-slider owl-carousel">
                                ...
                                <div class="single-doctor">
                                    ...
                                    <div class="doctor-info">
                                        ...
                                        <p>Senior Cardiac Anesthetist & Cardiac Intensivist</p>
                                        <div class="dr-appointment">
                                            <div class="apt"><h3><a href="http://111.92.84.180:23555/PP/PP/Login.aspx?" target="_blank">Appointment</a></h3></div>
                                            <div class="call"><a href="tel:+919656127678"><i class="fas fa-phone-alt"></i></a></div>
                                        </div>
                                ...
                                <div class="single-doctor">
                                    ...
                                    <div class="doctor-info">
                                        <h5 class="name">Dr.Arunkumar G</h5>
                                ...
                                <div class="single-doctor">
                                    <div class="doctor-photo">
                                        <img src="assets/img/doctors/sajan.jpg" alt="">
                                    </div>
                                    <div class="doctor-info">
