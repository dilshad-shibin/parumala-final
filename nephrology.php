...
<head>
<title>Best Nephrology in Pathanamthitta</title>
<!-- Style Links -->
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="bread-text bread-text2">
                                <h1 class="ortho-head"><span>Nephrology </span></h1>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="service-col">
                                <h2><strong>Dialysis Unit</strong></h2>
                                <p class="mb-3">Currently, the dialysis unit has 30 dialysis machines with most modern facilities. The department addresses the following needs of the patients; -</p>
                            </div>
