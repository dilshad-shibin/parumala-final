...
<head>
<title>Best Dermatology in Pathanamthitta</title>
<!-- Style Links -->
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="bread-text bread-text2">
                                <h1 class="ortho-head"><span>Dermatology  </span></h1>
                            ...
                            <div class="doctor-slider4 owl-carousel">
                                ...
                                <div class="single-doctor">
                                    <div class="doctor-photo">
                                        <img src="assets/img/doctors/rajeswary.jpg" alt="">
                                    </div>
                                    <div class="doctor-info">
                                        <h5 class="name">Dr.Rajeswary B</h5>
                                ...
                                <div class="single-doctor">
                                    <div class="doctor-photo">
                                        <img src="assets/img/doctors/santhi-john.jpg" alt="">
                                    </div>
                                    <div class="doctor-info">
                                        <h5 class="name">Dr.Santhi John Tharakan/h5>
                                        <p>Consultant Dermatologist</p>
                                        <div class="dr-appointment">
                                            <div class="apt"><h3>Appointment</h3></div>
                                            <div class="call"><a href="tel:+919656127678"><i class="fas fa-phone-alt"></i></a></div>
