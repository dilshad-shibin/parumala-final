        ...
        <div class="row emergency-area">
            ...
            <div class="col-lg-6 p-0">
                <div class="emergency-box">
                    <div class="icon"><img src="assets/img/footer-phone.png" alt=""></div>
                    <div class="text">
                        <div class="head">
                            <h3>Emergency :</h3>
                        </div>
                        <div class="number"><a href="tel:+91479231700">+91 479 2317000</a></div>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="footer-list footer-list-two">
                        ...
                        <div class="list-boxes">
                            ...
                            <ul class="list-items list-items2">
                                ...
                                <li><a href="psychiatry-de-addiction-and-rehabilitation.php">Phychiatry De Addiction & Rehabilitation</a></li>
