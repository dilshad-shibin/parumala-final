...
<head>
<title>Best Psychiatry De Addiction and Rehabilitation in Pathanamthitta</title>
<!-- Style Links -->
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="bread-text bread-text2">
                                <h1 class="ortho-head gastro-head"><span>Psychiatry  </span><br> De Addiction </h1>
                            ...
                            <div class="doctor-slider4 owl-carousel">
                                ...
                                <div class="single-doctor">
                                    <div class="doctor-photo">
                                        <img src="assets/img/doctors/kuruvila.jpg" alt="">
                                    </div>
                                ...
                                <div class="single-doctor">
                                    <div class="doctor-photo">
                                        <img src="assets/img/doctors/sherlyn-elizabeth.jpg" alt="">
                                    </div>
                                    <div class="doctor-info">
                                        <h5 class="name">Dr.Sherlyn Elizabeth Mammen</h5>
                                        <p>Consultant Psychiatrist</p>
                                        <div class="dr-appointment">
                                            <div class="apt"><h3>Appointment</h3></div>
                                            <div class="call"><a href="tel:+919656127678"><i class="fas fa-phone-alt"></i></a></div>
